...
const styles = StyleSheet.create({
  ...
  card: { backgroundColor: '#ffffff', borderRadius: 16, padding: 16, borderWidth: 1, borderColor: '#86efac' },
  statLabel: { fontSize: 11.5, fontWeight: '800', color: '#16a34a' },
  statVal: { fontSize: 22, fontWeight: '800', color: '#16a34a', marginVertical: 4 },
